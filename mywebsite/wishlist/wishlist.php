...
$query2 = "SELECT * FROM wishlist w INNER JOIN item i ON w.id_item=i.id_item INNER JOIN tshirt t ON t.id_tshirt= i.item where w.id_user = '$user'  ";

// $query3 = "SELECT * FROM item i INNER JOIN tshirt ts WHERE i.item=ts.id_tshirt";

$wishlist = mysqli_query($connect, $query2);



// $olo =  mysqli_fetch_assoc($wishlist);
...
<link rel="stylesheet" href="http://localhost/mywebsite/wishlist/style.css">
        ...
        <div class="container">
            ...
            <div class="product">
                <div class="product-content">
                    ...
                    <?php $i = 1; ?>
                    <?php while ($out = mysqli_fetch_assoc($wishlist)) : ?>

                        <a href="http://localhost/mywebsite/shop/detail.php?id_item=<?php echo $link['id_item'] ?>" style="text-decoration:none">
