                            ...
                            <tr>
                                <td width="400px">
                                    <div class="input-div one k">
                                        ...
                                        <div>
                                            <h5>Name</h5>
                                            <input class="input" type="text" name="nama" value="<?php echo $data['nama'] ?>" disabled>
                                        </div>
                                    </div>
                                </td>
                                <td rowspan="5">
                                    <div class="input-divs one">
                                        ...
                                        <div>
                                            ...
                                            <textarea disabled class="inputs" name="" id="" cols="30" rows="50"><?php echo $data['alamat'] ?></textarea>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <div class="input-div one ">
                                        ...
                                        <div>
                                            <h5>Username</h5>
                                            <input class="input" type="text" name="username" value="<?php echo $data['username'] ?>" disabled>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="input-div one ">
                                        ...
                                        <div>
                                            <h5>Password</h5>
                                            <input class="input" type="text" name="password" value="<?php echo $data['password'] ?>" disabled>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <div class="input-div two ">
                                        ...
                                        <div>
                                            <h5>No. Rekening </h5>
                                            <input class="input" type="text" name="norek" value="<?php echo $data['norek'] ?>" disabled>
                                        </div>
                                    </div>
                                </td>
                            </tr>
